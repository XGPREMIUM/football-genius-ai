...
PLAYERS = [
    ...
    ("Virgil van Dijk", "Virgil van Dijk", "1991-07-08", "Países Bajos", "Defensa central", "Derecha", 193, "Liverpool FC", "€30M", 60, 15, 77, 0, 0, 1, "Mejor defensa del mundo en su prime. MVP de la Champions 2019.", "Anticipación, liderazgo, juego aéreo, velocidad, salida de balón", "Defensa central dominante, comandante de la línea"),
    ("Karim Benzema", "Karim Mostafa Benzema", "1987-12-19", "Francia", "Delantero centro", "Derecha", 185, "Al-Ittihad", "€15M", 450, 150, 97, 1, 0, 5, "Balón de Oro 2022. Leyenda del Real Madrid. MVP de la Champions 2022.", "Finalización, asociación, inteligencia, técnica, liderazgo", "Delantero centro total, falso 9"),
    ("Sergio Busquets", "Sergio Busquets i Burgos", "1988-07-16", "España", "Centrocampista defensivo", "Derecha", 189, "Inter Miami", "€5M", 20, 40, 143, 0, 1, 3, "Mejor pivote defensivo de la historia. Cerebro del mejor Barça y España.", "Visión, inteligencia, positioning, pase, temple", "Pivote, mediocentro defensivo puro"),
    ("Toni Kroos", "Toni Kroos", "1990-01-04", "Alemania", "Centrocampista", "Derecha", 183, None, "-", 85, 105, 106, 0, 1, 6, "Metrónomo alemán. Dueño absoluto de la circulación. 6 Champions.", "Pase, visión, control de ritmo, precisión, frialdad", "Centrocampista organizador, mediocentro posicional"),
    ("N'Golo Kanté", "N'Golo Kanté", "1991-03-29", "Francia", "Centrocampista defensivo", "Derecha", 168, "Al-Ittihad", "€10M", 30, 25, 60, 0, 1, 1, "Corazón del Leicester, Chelsea y Francia. Infatigable recuperador.", "Recuperación, coberturas, energía, inteligencia defensiva, humildad", "Pulmón del mediocampo, box-to-box defensivo"),
    ("Kylian Mbappé", "Kylian Mbappé Lottin", "1998-12-20", "Francia", "Delantero/Extremo", "Derecha", 178, "Real Madrid", "€180M", 350, 120, 86, 0, 1, 0, "Superestrella francesa. Campeón del Mundo 2018 con apenas 19 años.", "Velocidad, regate, definición, desmarque, potencia", "Extremo izquierdo, delantero centro"),
    ("Jan Oblak", "Jan Oblak", "1993-01-07", "Eslovenia", "Portero", "Derecha", 188, "Atlético de Madrid", "€25M", 0, 0, 73, 0, 0, 0, "Mejor portero del mundo en su prime. Récord de imbatibilidad en LaLiga.", "Reflejos, colocación, seguridad, juego aéreo, liderazgo", "Portero de elite, seguro bajo palos"),
    ("Marc-André ter Stegen", "Marc-André ter Stegen", "1992-04-30", "Alemania", "Portero", "Izquierda", 187, "FC Barcelona", "€25M", 0, 0, 40, 0, 0, 1, "Portero del Barça. Top mundial en juego de pies. Zamora 2023.", "Juego de pies, reflejos, saques, liderazgo, concentración", "Portero moderno, sweeper keeper"),
    ("Alisson Becker", "Alisson Becker", "1992-10-02", "Brasil", "Portero", "Derecha", 191, "Liverpool FC", "€30M", 0, 0, 69, 0, 0, 1, "MVP de la Champions 2019. Mejor portero del mundo en 2019.", "Reflejos, uno contra uno, juego aéreo, saques, liderazgo", "Portero completo, sweeper keeper"),
    ("Joshua Kimmich", "Joshua Kimmich", "1995-02-08", "Alemania", "Centrocampista/Lateral", "Derecha", 176, "FC Bayern München", "€50M", 45, 100, 97, 0, 0, 1, "Cerebro del Bayern. Dueño del mediocampo bávaro. Top mundial.", "Pase, visión, inteligencia, polivalencia, liderazgo", "Centrocampista total, lateral invertido"),
    ("Declan Rice", "Declan Rice", "1999-01-14", "Inglaterra", "Centrocampista defensivo", "Derecha", 185, "Arsenal FC", "€110M", 20, 15, 61, 0, 0, 0, "Pivote de élite. Líder del Arsenal y de Inglaterra. Récord de fichaje inglés.", "Recuperación, físico, pase, liderazgo, inteligencia defensiva", "Pivote defensivo, box-to-box"),
    ("Harry Kane", "Harry Edward Kane", "1993-07-28", "Inglaterra", "Delantero centro", "Derecha", 188, "FC Bayern München", "€100M", 380, 80, 103, 0, 0, 1, "Máximo goleador histórico de Inglaterra. Bota de Oro Mundial 2018.", "Finalización, asociación, visión, juego de espaldas, cabeza", "Delantero centro total, falso 9"),
    ("Víctor Osimhen", "Victor Osimhen", "1998-12-29", "Nigeria", "Delantero centro", "Derecha", 185, "Galatasaray SK", "€70M", 130, 25, 38, 0, 0, 0, "Mejor delantero africano del momento. Héroe del Nápoles Scudetto 2023.", "Velocidad, potencia, definición, juego aéreo, desmarque", "Delantero centro de referencia, ataque al espacio"),
    ("Jamal Musiala", "Jamal Musiala", "2003-02-26", "Alemania", "Mediapunta/Extremo", "Derecha", 180, "FC Bayern München", "€130M", 40, 30, 36, 0, 0, 0, "Joyaa del Bayern. Mejor regateador del mundo en espacios reducidos.", "Regate, creatividad, visión, desborde, talento puro", "Mediapunta creativo, extremo que se mete al centro"),
    ("Rodrigo De Paul", "Rodrigo De Paul", "1994-05-24", "Argentina", "Centrocampista", "Derecha", 180, "Atlético de Madrid", "€35M", 25, 45, 70, 0, 1, 0, "Corazón de Argentina campeona del mundo 2022. Motor del mediocampo.", "Presión, pase, energía, liderazgo, polivalencia", "Box-to-box, interior total"),
    ("Lisandro Martínez", "Lisandro Martínez", "1998-01-18", "Argentina", "Defensa central", "Izquierda", 175, "Manchester United", "€50M", 15, 8, 28, 0, 1, 0, "Butcher. Defensa argentino campeón del mundo. Líder del United.", "Anticipación, agresividad, salida de balón, liderazgo, carácter", "Defensa central agresivo, líbero moderno"),
    ("Federico Valverde", "Federico Valverde", "1998-07-22", "Uruguay", "Centrocampista", "Derecha", 182, "Real Madrid", "€120M", 45, 30, 65, 0, 0, 2, "Motor del Real Madrid. Box-to-box total. Dueño del mediocampo merengue.", "Llegada, disparo, físico, recuperación, polivalencia", "Box-to-box, interior total"),
    ("Bruno Fernandes", "Bruno Miguel Fernandes", "1994-09-08", "Portugal", "Centrocampista ofensivo", "Derecha", 179, "Manchester United", "€70M", 100, 80, 72, 0, 0, 0, "Creador del United. Top en asistencias desde su llegada.", "Pase, visión, disparo, liderazgo, llegada", "Mediapunta, interior ofensivo, organizador"),
    ("Bernardo Silva", "Bernardo Mota Silva", "1994-08-10", "Portugal", "Centrocampista/Extremo", "Izquierda", 173, "Manchester City", "€70M", 60, 80, 98, 0, 0, 1, "Genio portugués. Dueño del juego asociativo del City.", "Control, pase, inteligencia, trabajo, polivalencia", "Interior, extremo, mediapunta"),
    ("Rafael Leão", "Rafael Alexandre da Conceição Leão", "1999-06-10", "Portugal", "Extremo/Delantero", "Derecha", 188, "AC Milan", "€75M", 55, 35, 36, 0, 0, 0, "Estrella del Milan. MVP de la Serie A 2022. Extremo total.", "Regate, velocidad, potencia, desborde, físico", "Extremo izquierdo, delantero centro"),
    ("Achraf Hakimi", "Achraf Hakimi", "1998-11-04", "Marruecos", "Lateral derecho", "Derecha", 181, "Paris Saint-Germain", "€65M", 30, 40, 80, 0, 0, 0, "Mejor lateral derecho del mundo 2023. Velocidad y llegada ofensiva.", "Velocidad, ataque, regate, resistencia, polivalencia", "Carrilero total, lateral ofensivo"),
    ("Trent Alexander-Arnold", "Trent Alexander-Arnold", "1998-10-07", "Inglaterra", "Lateral derecho/Centrocampista", "Derecha", 180, "Liverpool FC", "€70M", 20, 90, 33, 0, 0, 1, "Mejor pasador del mundo desde lateral. Récord de asistencias defensa PL.", "Pase, visión, precisión, centros, inteligencia ofensiva", "Lateral ofensivo, inverted fullback, centrocampista"),
    ("Jude Bellingham", "Jude Victor William Bellingham", "2003-06-29", "Inglaterra", "Centrocampista", "Derecha", 186, "Real Madrid", "€200M", 65, 35, 40, 0, 0, 0, "Estrella total del Real Madrid. MVP de LaLiga 2023-24.", "Llegada, físico, técnica, inteligencia, liderazgo", "Box-to-box, mediapunta"),
    ("Erling Haaland", "Erling Braut Haaland", "2000-07-21", "Noruega", "Delantero centro", "Izquierda", 194, "Manchester City", "€200M", 320, 55, 39, 0, 0, 0, "Máquina de goles. Récord de goles en Premier League en una temporada (36).", "Remate, físico, velocidad, posicionamiento, potencia", "Delantero centro de referencia"),
    ("Lamine Yamal", "Lamine Yamal Nasraoui Ebana", "2007-07-13", "España", "Extremo", "Izquierda", 180, "FC Barcelona", "€180M", 18, 22, 20, 0, 0, 0, "Joyaa de La Masia. Más joven en debutar y marcar con Barça y España. Eurocopa 2024.", "Regate, desborde, visión, madurez, creatividad", "Extremo derecho que recorta hacia el interior"),
]
...
TEAMS = [
    ...
    ("Newcastle United", "Newcastle United Football Club", "Inglaterra", "St. James' Park", 52305, 1892, "Premier League", "Eddie Howe", 4, 1, "Magpies. Resurgir con fondo saudí. Vuelta a Champions 2023."),
    ("Aston Villa", "Aston Villa Football Club", "Inglaterra", "Villa Park", 42682, 1874, "Premier League", "Unai Emery", 7, 1, "Villanos. 1 Champions (1982). Resurgir con Emery."),
    ("West Ham United", "West Ham United Football Club", "Inglaterra", "London Stadium", 62500, 1895, "Premier League", "Julen Lopetegui", 0, 1, "Hammers. Conference League 2023. Fútbol de resistencia."),
    ("Everton FC", "Everton Football Club", "Inglaterra", "Goodison Park", 39414, 1878, "Premier League", "David Moyes", 9, 1, "Toffees. Miembro fundador de la Football League. Historia en Merseyside."),
    ("Leeds United", "Leeds United Football Club", "Inglaterra", "Elland Road", 37608, 1919, "Championship", "Daniel Farke", 3, 0, "Peacocks. Era Bielsa 2018-2022. Revivió al gigante dormido."),
    ("Leicester City", "Leicester City Football Club", "Inglaterra", "King Power Stadium", 32261, 1884, "Premier League", "Enzo Maresca", 1, 0, "Foxes. Hazaña 2016: Premier League con 5000-1 de cuota."),
    ("Crystal Palace", "Crystal Palace Football Club", "Inglaterra", "Selhurst Park", 25486, 1905, "Premier League", "Oliver Glasner", 0, 0, "Eagles. Especialistas en FA Cup. Himno: Glad All Over."),
    ("VfL Wolfsburg", "VfL Wolfsburg", "Alemania", "Volkswagen Arena", 30000, 1945, "Bundesliga", "Ralph Hasenhüttl", 1, 0, "Lobos. Bundesliga 2009. Propiedad de Volkswagen."),
    ("Bayer 04 Leverkusen", "Bayer 04 Leverkusen", "Alemania", "BayArena", 30210, 1904, "Bundesliga", "Xabi Alonso", 1, 1, "Aspirinas. Bundesliga invicto 2024 con Xabi Alonso. Finalista Champions 2002."),
    ("Eintracht Frankfurt", "Eintracht Frankfurt", "Alemania", "Deutsche Bank Park", 51500, 1899, "Bundesliga", "Dino Toppmöller", 1, 1, "Águilas. Europa League 2022. Hinchada mítica."),
    ("RB Leipzig", "RasenBallsport Leipzig", "Alemania", "Red Bull Arena", 42146, 2009, "Bundesliga", "Marco Rose", 2, 0, "Toros Rojos. Proyecto Red Bull. Ascenso meteórico a la élite."),
    ("VfB Stuttgart", "VfB Stuttgart", "Alemania", "MHPArena", 60449, 1893, "Bundesliga", "Sebastian Hoeneß", 5, 0, "Mercedes-Benz Stadt. Cantera legendaria (Khedira, Gómez, Werner)."),
    ("Olympique Marseille", "Olympique de Marseille", "Francia", "Orange Vélodrome", 67394, 1899, "Ligue 1", "Roberto De Zerbi", 9, 1, "Phocéens. Único francés en ganar Champions (1993). Afición volcánica."),
    ("AS Monaco", "Association Sportive de Monaco", "Francia", "Stade Louis II", 18523, 1924, "Ligue 1", "Adi Hütter", 8, 0, "Monegascos. Fábrica de talentos (Mbappé, Henry, Wiltord)."),
    ("OGC Nice", "OGC Nice", "Francia", "Allianz Riviera", 36178, 1904, "Ligue 1", "Franck Haise", 4, 0, "Aiglons. Propiedad de Ineos. Resurgir en Ligue 1."),
    ("Lille OSC", "Lille Olympique Sporting Club", "Francia", "Stade Pierre-Mauroy", 50186, 1944, "Ligue 1", "Bruno Génésio", 4, 0, "Dogues. Ligue 1 2021 rompiendo el dominio del PSG. Cantera excelente."),
    ("RSC Anderlecht", "Royal Sporting Club Anderlecht", "Bélgica", "Lotto Park", 22500, 1908, "Jupiler Pro League", "Brian Riemer", 34, 1, "Morado y blanco. El más laureado de Bélgica. 1 UEFA (1983)."),
    ("Club Brugge", "Club Brugge KV", "Bélgica", "Jan Breydel Stadium", 29062, 1891, "Jupiler Pro League", "Nicky Hayen", 18, 0, "Blauw-Zwart. Dominador de Bélgica. Semifinalista UEFA 1990."),
    ("FC København", "Football Club København", "Dinamarca", "Parken Stadium", 38065, 1992, "Superliga", "Jacob Neestrup", 15, 0, "Løverne. Gigante danés. Champions League recurrente."),
    ("Feyenoord Rotterdam", "Feyenoord Rotterdam", "Países Bajos", "De Kuip", 51117, 1908, "Eredivisie", "Brian Priske", 16, 1, "Stadionclub. 1 Champions (1970). La pasión de Rotterdam."),
    ("FC Twente", "FC Twente", "Países Bajos", "De Grolsch Veste", 30205, 1965, "Eredivisie", "Joseph Oosting", 1, 0, "Tukkers. Eredivisie 2010. Cantera de clase media holandesa."),
    ("SK Rapid Wien", "Sportklub Rapid Wien", "Austria", "Allianz Stadion", 28000, 1899, "Austrian Bundesliga", "Robert Klauß", 32, 0, "Grün-Weiß. El gigante vienés. 32 ligas austriacas."),
    ("Legia Warsaw", "Legia Warszawa", "Polonia", "Stadion Wojska Polskiego", 31800, 1916, "Ekstraklasa", "Gonçalo Feio", 15, 0, "Legioniści. El más laureado de Polonia. Cuartos Champions 1996."),
    ("GNK Dinamo Zagreb", "Dinamo Zagreb", "Croacia", "Stadion Maksimir", 35000, 1911, "HNL", "Fabio Cannavaro", 24, 0, "Modri. Cantera de élite (Modrić, Kovačić, Gvardiol)."),
    ("PAOK FC", "PAOK FC", "Grecia", "Toumba Stadium", 28803, 1926, "Super League Greece", "Răzvan Lucescu", 4, 0, "Dikéfalos tou Vorrá. El gigante del norte de Grecia."),
    ("FC Spartak Moscow", "Spartak Moscow", "Rusia", "Lukoil Arena", 45360, 1922, "Russian Premier League", "Dejan Stanković", 22, 0, "Krasno-belye. El equipo del pueblo ruso. 22 ligas."),
    ("FC Zenit Saint Petersburg", "FC Zenit Saint Petersburg", "Rusia", "Gazprom Arena", 67800, 1925, "Russian Premier League", "Sergei Semak", 10, 0, "Sine-belo-golubye. Dominador actual de Rusia. UEFA 2008."),
    ("Red Star Belgrade", "Fudbalski klub Crvena zvezda", "Serbia", "Stadion Rajko Mitić", 53000, 1945, "Serbian SuperLiga", "Vladan Milojević", 34, 1, "Zvezda. Único serbio en ganar Champions (1991). Del Pueblo."),
]
